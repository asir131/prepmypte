...
const PracticeOverview = () => {
  ...
  return (
    <div className="lg:min-h-[640px] mt-20 lg:-mt-20 lg:bg-[#F5F5F5] lg:rounded-tl-[20rem] lg:rounded-br-[20rem] sm:rounded-tl-[10rem] sm:rounded-br-[10rem] p-10 flex flex-col justify-center items-center">
      {/* Header */}
