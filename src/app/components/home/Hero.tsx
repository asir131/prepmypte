    ...
    <div className="-mt-[500px] lg:-mt-30  relative min-h-[100px] lg:min-h-[620px]">
      <div className="w-full relative">
        ...
        <div className="absolute hidden lg:block bottom-1 -left-5">
          <Image className="w-full lg:w-[55%] xl-[90%] 2xl:w-[80%] " src={girl} height={100} width={510} alt="" />
        </div>
        <div className=" absolute  hidden lg:block  justify-center  lg:right-35 lg:top-30 ">
          <div className="font-bold text-2xl lg:text-[40px] xl:text-[70px] text-center   text-white ">
        ...
        <div className=" absolute top-5 left-12 xs:top-8 xs:left-20 sm:top-20 sm:left-40 md:top-25 md:left-40  lg:hidden  justify-center lg:right-15 lg:top-20">
